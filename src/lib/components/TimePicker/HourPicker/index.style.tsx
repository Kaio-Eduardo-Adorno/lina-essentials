...
export const HourPickerWrapper = styled('div')`
  ...
  align-items: center;
`;
export const HourPickerHeader = styled('div')`
  @import url('https://fonts.googleapis.com/css2?family=Roboto&display=swap');
  display: flex;
  margin: 6px 0 16px;
  font-weight: 700;
  ...
  align-items: center;
`;
export const HourPickerOptions = styled(CustomScrollBar)`
  @import url('https://fonts.googleapis.com/css2?family=Roboto&display=swap');
  display: flex;
  min-height: 250px;
  flex-direction: column;
  ...
  overflow-y: scroll;
`;
export const HourPickerOption = styled('button')<{ isSelected?: boolean }>`
  @import url('https://fonts.googleapis.com/css2?family=Roboto&display=swap');
  cursor: pointer;
  display: flex;
  align-items: center;
